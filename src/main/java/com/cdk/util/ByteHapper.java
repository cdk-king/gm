...
public class ByteHapper {
    ...
    public static byte[] Number2byte(long val) {
        ...
        byte[] arr = new byte[]{(byte) ((val >> 56) & 0xFF), (byte) ((val >> 48) & 0xFF), (byte) ((val >> 40) & 0xFF), (byte) ((val >> 32) & 0xFF),
    ...
    public static byte[] Number2byte(int val) {
        ...
        byte[] arr = new byte[]{(byte) ((val >> 24) & 0xFF), (byte) ((val >> 16) & 0xFF), (byte) ((val >> 8) & 0xFF), (byte) (val & 0xFF)};
    ...
    public static byte[] Number2byte(short val) {
        ...
        byte[] arr = new byte[]{(byte) ((val >> 8) & 0xFF), (byte) (val & 0xFF)};
