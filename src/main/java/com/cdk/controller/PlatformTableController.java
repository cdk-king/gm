...
public class PlatformTableController {
    ...
    public Result addPlatform(@RequestBody Map map){
        ...
        String sql="insert into t_gameplatform (platform,platformTag,platform_describe,gameId,roleId,sort,addUser,addDatetime,state,isDelete) "+
                " values ('"+platform+"','"+platformTag+"','"+platform_describe+"','"+gameId+"','"+roleId+"','0','"+addUser+"','"+addDatetime+"','0','0')";
        System.out.println("sql：" + sql);
    ...
    public Result editPlatform(@RequestBody Map map){
        ...
        String sql = "UPDATE t_gameplatform as a SET a.platform='"+platform+"',a.platform_describe = '"+ platform_describe +"',"
                +"a.gameId='"+gameId+"',a.roleId='"+roleId+"',"
                +"a.platformTag='"+  platformTag+"' ,a.addUser = '"+ addUser +
                "' where a.id =" + id +"";
        System.out.println("sql：" + sql);
        Object args[] = new Object[]{id};
        int temp = jdbcTemplate.update(sql);
